  ...
  return (
    <Router>
      <div className="overflow-x-hidden">
        <nav className="bg-white bg-opacity-30 backdrop-filter backdrop-blur-lg fixed top-0 left-0 right-0 navbar flex flex-wrap items-center justify-between px-2 py-3">
