...
function Mission() {
    return (
        <div>
            {/* <section class="" style={{ backgroundImage: `url("https://images.pexels.com/photos/433154/pexels-photo-433154.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")` }}>
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: `url("https://images.pexels.com/photos/433154/pexels-photo-433154.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")` }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-4xl font-bold text-white">IGORAZA Consultancy</h1>
                        <p className="mb-5 text-white">We help businesses propel into the digital service economy with our innovative solutions and advisory services. </p>
                    </div>
                </div>
            </div>
