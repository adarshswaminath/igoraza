  ...
  return (
    <div>
      <section className="text-gray-700 bg-gray-100 mb-3">
        <div className="hero h-screen bg-cover bg-no-repeat bg-center relative" style={{ backgroundImage: `url(${image})` }}>
          ...
          <div className="hero-content flex-col lg:flex-row-reverse h-full">
            <div className="flex flex-col justify-center px-4 lg:px-0 lg:ml-8 xl:ml-16 2xl:ml-24">
              ...
              <button className="btn w-40 lg:w-96 mx-auto border-none rounded-full bg-[#1d3557] hover:bg-[#1d3545] text-white font-bold uppercase tracking-wider">
                Get Started
              </button>
            </div>
          </div>
