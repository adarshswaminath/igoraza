          ...
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <p className="text-lg bg-base-400 p-4">
                IGORAZA is a progressive technological startup established by a consortium of passionate engineers. We are determined to advance humanity through slashing-edge technology innovations. By employing the most up-to-date software and techniques, we focus on creating and establishing exceptional solutions for our clients.<br />
